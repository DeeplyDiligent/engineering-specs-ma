...
import { Plus, Trash, ArrowUp, ArrowDown, FileArrowUp, TextAa, CheckSquare } from '@phosphor-icons/react';
...
export function SchemaEditorDialog({ open, onOpenChange }: SchemaEditorDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-semibold">Schema Editor</DialogTitle>
        </DialogHeader>

        {view === 'categories' && (
          <div className="space-y-4 mt-4">
            <div className="flex justify-between items-center">
              <p className="text-sm text-muted-foreground">Select a category to edit its pages</p>
              <Button onClick={() => setView('newCategory')} className="gap-2">
                <Plus /> New Category
              </Button>
            </div>
        ...
        {view === 'pages' && selectedCategory && (
          <div className="space-y-4 mt-4">
            <div className="flex justify-between items-center">
              ...
              <Button onClick={() => setView('newPage')} className="gap-2">
                <Plus /> New Page
              </Button>
            </div>
        ...
        {view === 'newPage' && selectedCategory && (
          <div className="space-y-4 mt-4">
            <Button variant="outline" onClick={() => setView('pages')}>
              ← Back
            </Button>
            <div className="space-y-4">
              <div className="space-y-2">
        ...
        {view === 'editPage' && editingPage && (
          <div className="space-y-4 mt-4">
            ...
            <div>
              <h3 className="font-semibold text-lg">{editingPage.name}</h3>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <Label className="text-base font-semibold">Blocks</Label>
